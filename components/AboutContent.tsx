      ...
      <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-24">
        ...
        >
          ...
          <h2 className="font-serif text-4xl leading-[1.1] md:text-5xl lg:text-6xl font-medium text-zinc-900 tracking-tight">
            ...
            <span className="text-gold-dark font-script font-normal text-5xl md:text-6xl lg:text-7xl">
              Cultural
            </span>{" "}
            Movement
          </h2>
        ...
        >
          <p className="first-letter:text-6xl first-letter:font-serif first-letter:font-bold first-letter:text-gold-dark first-letter:mr-3 first-letter:float-left">
            The Organization for the Advancement of Anioma Culture (OFAAC)
            stands as the preeminent cultural umbrella body for the Anioma
            people, nestled within Delta State, Nigeria.
          </p>
          <p>
            Established in November 2003, OFAAC emerged from a profound
            commitment to safeguard, celebrate, and propel forward the unique
            cultural tapestry of the Anioma nation.
          </p>
          <p>
            As a non-governmental and non-political entity, our membership
            transcends geographical boundaries, embracing all sons and daughters
            of Anioma, alongside non-Anioma individuals who share a vested
            interest in the advancement of Nigeria&apos;s rich cultural
            heritage.
          </p>
        </motion.div>
      </div>
