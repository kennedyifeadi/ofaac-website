...
const objectives = [
  {
    ...
    description:
      "To diligently preserve, promote, and advance the appreciation and development of the rich cultural heritage of the Anioma people and Nigeria.",
    image: DSC_38,
  },
  {
  ...
  },
  {
    ...
    description:
      "To promote the widespread use and appreciation of traditional Anioma attires, such as the iconic Akwa-Ocha.",
    image: DSC_47,
  },
  {
      ...
      <div className="max-w-[1400px] mx-auto flex flex-col items-center">
        ...
        >
          ...
          <h2 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-medium tracking-tight text-zinc-900">
            Pillars of Our{" "}
            <span className="font-script text-gold-dark text-5xl sm:text-6xl lg:text-7xl">
              Endeavor
            </span>
          </h2>
        </motion.div>
